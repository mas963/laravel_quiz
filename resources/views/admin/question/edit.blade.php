<x-app-layout>
    <x-slot name="header">{{ $question->question }} düzenlemesi</x-slot>
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{ route('questions.update',[$question->quiz_id,$question->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <a href="{{asset($question->image)}}" target="_blank">
                        <img src="{{asset($question->image)}}" style="width: 300px">
                    </a>
                    @endif
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-sm btn-block w-100 mt-3"><i class="fa fa-edit"
                            aria-hidden="true"></i> Soruyu düzenle</button>
                </div>
            </form>
        </div>
    </div>
